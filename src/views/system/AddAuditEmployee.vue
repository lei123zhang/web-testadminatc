        ...
        <Row class="mainEmployeeContent">
          ...
          label-position="right">
            ...
            <FormItem label="部门：" prop="depart">
              ...
              <Select v-model="formWrapperObj['country.zhName']">
                <Option v-for="country in countryArr" :key="country.areaCode" :value="country.zhName">{{ country.zhName }}</Option>
              </Select>
            </FormItem>
...
import { getAllCountry, roleManage, departmentManage, addAuditEmployee, employeeDetail } from '@/service/getData'
